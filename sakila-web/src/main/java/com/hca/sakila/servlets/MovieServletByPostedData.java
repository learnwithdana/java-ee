 ...
 */
@WebServlet(description = "Find movies by genre POSTED to servlet", urlPatterns = { "/movies/postrequest" })
public class MovieServletByPostedData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// gets the values for the key "genre" that is in the request body (ex: genre=comedy&genre=action )
